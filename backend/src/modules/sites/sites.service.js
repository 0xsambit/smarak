...
import { getActorRole, resolveActorState, toIdString } from '../../common/scope/scope.utils.js';

@Injectable()
export class SitesService {
  constructor(@InjectModel(Site.name) siteModel) {
  ...
  async applyRoleScopeToFilter(filter, actor) {
