...
const PROTECTION_OPTIONS = ["PROTECTED", "RESTRICTED", "OPEN"];
...
const parseSiteFormPayload = (values) => ({
				...
				<section className="rounded-xl border border-stone-200 bg-white p-4">
					<div className="grid grid-cols-1 gap-3 md:grid-cols-6">
						...
						<select
							...
							onChange={(event) => {
								setPage(1);
								setProtectionFilter(event.target.value);
							}}
							className="rounded-md border border-stone-300 px-3 py-2 text-sm focus:border-stone-500 focus:outline-none">
						...
						<form onSubmit={handleSubmit} className="space-y-4">
							<div className="grid grid-cols-1 gap-3 md:grid-cols-2">
								...
								<input
									...
									onChange={(event) =>
										onFormChange("visitorCapacity", event.target.value)
									}
								...
								<select
									...
									onChange={(event) =>
										onFormChange("protectionStatus", event.target.value)
									}
									className="rounded-md border border-stone-300 px-3 py-2 text-sm focus:border-stone-500 focus:outline-none">
									{PROTECTION_OPTIONS.map((option) => (
										<option key={option} value={option}>
								...
								<select
									...
									onChange={(event) =>
										onFormChange("riskLevel", event.target.value)
									}
									className="rounded-md border border-stone-300 px-3 py-2 text-sm focus:border-stone-500 focus:outline-none">
									{RISK_OPTIONS.map((option) => (
										<option key={option} value={option}>
								...
								<input
									...
									onChange={(event) =>
										onFormChange("lastInspectionDate", event.target.value)
									}
									className="rounded-md border border-stone-300 px-3 py-2 text-sm focus:border-stone-500 focus:outline-none"
								/>
							</div>
