...
const toCreatePayload = (values: IncidentFormValues) => ({
...
const toUpdatePayload = (values: IncidentFormValues) => ({
	siteId: values.siteId,
	type: values.type,
	severity: values.severity,
	description: values.description.trim(),
...
const toFormValues = (incident: IncidentRecord): IncidentFormValues => ({
...
const Incidents: React.FC = () => {
	...
	const openEdit = (incident: IncidentRecord) => {
	...
	const handleArchive = async (incident: IncidentRecord) => {
		if (!canArchive) {
	...
	const handleRestore = async (incident: IncidentRecord) => {
		if (!canArchive) {
	...
	const onFormChange = <K extends keyof IncidentFormValues>(
		key: K,
